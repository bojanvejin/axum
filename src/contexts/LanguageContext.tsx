...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    sign_in_prompt: "Please enter your name to track your progress and access full features.",
    ...
    login_prompt_message: "Enter your name to access the curriculum.",
  ...
  fr: {
    ...
    loading_session: "Chargement...",
    sign_in_prompt: "Veuillez entrer votre nom pour suivre vos progrès et accéder à toutes les fonctionnalités.",
    ...
    login_prompt_message: "Entrez votre nom pour accéder au programme.",
    ...
    login: "Connexion",
    logged_in_as: "Connecté(e) en tant que {{name}}",
    loading: "Chargement...",
  },
};

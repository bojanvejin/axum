...
export const seedLessons: CurriculumLesson[] = [
  ...
  { id: generateId(), module_id: moduleAppendicesAId, title: "Clippers, Blades, Motors", objectives: "Understand the types and functions of various cutting tools.", content_html: "<h3>Appendix A: Tool Encyclopedia — Clippers, Blades, Motors</h3><p>This section provides an in-depth look at the different types of clippers, blades, and motors used in professional barbering. Learn about their maintenance, usage, and how to choose the right tool for the job.</p>", order_index: 0, quiz_id: null },
  { id: generateId(), module_id: moduleAppendicesBId, title: "Sanitation, Disinfection & Regulations", objectives: "Master salon hygiene and comply with industry regulations.", content_html: "<h3>Appendix B: Sanitation, Disinfection & Regulations</h3><p>This appendix covers all aspects of sanitation and disinfection in a barbering environment, including state board regulations, proper cleaning procedures, and product safety.</p>", order_index: 0, quiz_id: null },
  { id: generateId(), module_id: moduleAppendicesCId, title: "Hair & Scalp Science Atlas", objectives: "Gain a scientific understanding of hair and scalp health.", content_html: "<h3>Appendix C: Hair & Scalp Science Atlas</h3><p>Delve into the anatomy and physiology of hair and scalp. Understand common conditions, hair growth cycles, and how different treatments affect hair structure.</p>", order_index: 0, quiz_id: null },
  { id: generateId(), module_id: moduleAppendicesDId, title: "First Aid & Blood Spill Protocol", objectives: "Learn emergency first aid and blood spill procedures.", content_html: "<h3>Appendix D: First Aid & Blood Spill Protocol</h3><p>This section provides crucial information on handling minor injuries and implementing blood spill protocols to ensure client and barber safety.</p>", order_index: 0, quiz_id: null },
